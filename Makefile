SOURCES=streamsurfer.go structure.go config.go monitor.go monitor-prober.go http-client.go http-api.go stats.go  logger.go zabbix.go helpers.go templates.go webui-report.go # reports.go source-loader.go
HTML=html/*.html
