SOURCES=streamsurfer.go structure.go source-loader.go monitor.go monitor-prober.go http-client.go http-api.go stats.go reports.go logger.go zabbix.go helpers.go templates.go
HTML=html/*.html
